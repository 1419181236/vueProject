<template>
  <div class="flap-card-wrapper" v-show="flapCardVisible">
    <div class="flap-card-bg" :class="{'animation': runFlapCadAnimation}"
    v-show="runFlapCadAnimation">
...
export default {
  ...
  methods: {
    ...
    flapCardRotate() {
      const frontFlapCard = this.flapCardList[this.font]
    ...
    reset () {
      ...
      this.flapCardList.forEach((item, index) => {
        ...
        item._g = item.g
        item.rotateDegree = 0
        this.rotate(index, 'font')
        this.rotate(index, 'back')
      })
      this.runBookCardAnimation = false
      this.runFlapCadAnimation = false
    ...
    runAnimation() {
      this.runFlapCadAnimation = true
      this.timeout = setTimeout(() => {
        this.startFlapCardAnimation()
        this.statPointAnimation()
      }, 300)
